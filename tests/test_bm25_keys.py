...
def test_matches_components_of_punctuated_source_url(vault):
    _write(vault, "vic/ACME/note.md", 'source: "https://example.com/research"')
    results = bm25.bm25_search("example", top_k=5)
